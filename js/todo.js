...
function fillTodoList(dataSnapshot) {
  ...
  dataSnapshot.forEach(function(item) {
    ...
    if (canEditTodoList) {
      ...
      liUpdateBtn.setAttribute(
        "title",
        "Atualizar usando os dados do formulário"
      );
...
function updateTodo(todoKey) {
  ...
  addUpdateTodoText.innerHTML =
    '<strong>Atualizar a tarefa: "' + liSelected.innerHTML + '"</strong>';
...
function removeTodo(key) {
  ...
  var confirmation = confirm(
    "Realmente deseja remover (" + liSelected.innerHTML + ")"
  );
